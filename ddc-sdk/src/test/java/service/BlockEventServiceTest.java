...
class BlockEventServiceTest {
    ...
    DDCSdkClient ddcSdkClient = DDCSdkClient.builder()
            ...
            .setAuthorityAddress("0x466D5b0eA174a2DD595D40e0B30e433FCe6517F5")  //生产
            .setChargeAddress("0xCa97bF3a19403805d391102908665b16B4d0217C")     //生产
            .setDdc721Address("0xad3B52B4F4bd9198DC69dD9cE4aC9846667461a2")     //生产
            .setDdc1155Address("0x061e59c74815994DAb4226a0D344711F18E0F418")    //生产
            .setCrossChainAddress("0xc4E12bB845D9991ee26718E881C712B2c0cB2048") //生产
    ...
    void getBlockEvent() throws Exception {
        ...
        result.addAll(ddcSdkClient.blockEventService.getBlockEvent(new BigInteger("4361718")));
